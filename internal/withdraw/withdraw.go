...
// Asset 전송 자산 (payment.Asset 과 동일 구조 — 슬라이스 독립 위해 별도 정의)
type Asset struct {
...
// StatusRequest 출금 상태 확인 요청 페이로드
//
// TODO(설계): 페이로드 샘플 없음 — confirm 요청에서 추론, 구현 전 확정
...
// Confirmed 출금 최종 결과 페이로드
//
// TODO(설계): 페이로드 샘플 없음 — confirm 결과에서 추론, 구현 전 확정
